...
Committed to GitHub repository
        ↓
Converted to PowerPoint (.pptx) or PDF or a single-page-html for stakeholder distribution
```
...
- Write for a technical reader, a professional or aspiring professional who was not involved in building the system
- Assume the reader is a novice and intends to build domain expertise, not intimately familiar with the specific implementation
